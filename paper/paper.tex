...
\begin{enumerate}[noitemsep]
  ...
  \item \textbf{Different polytope}: The obstruction is specific
    to the intersection tensor of h26/P11670.
    Polytopes with smaller $\max|\kappa_{kab}|$ --- common at
    lower $h^{1,1}$, $h^{1,1} \leq 16$ --- could satisfy
    $\ch_2(V) \leq c_2(TX)$ at integer charges, at the cost
    of a lower composite score (cf.\ h16/P118 at score 76).
